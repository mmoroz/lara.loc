<x-app-layout>
    ...
    <div class="pt-2 p-4 text-gray-900">
        <h1 class="py-4">Редактировать атрибут</h1>
        ...
        <form method="POST" action="{{ route('admin.categories.attributes.update', [$category, $attribute]) }}">
            ...
            <div class="flex flex-wrap mb-4 w-full">
                ...
                <div class="w-1/2 pr-4">
                    ...
                    <x-text-input value="{{ old('name', $attribute->name) }}" id="name" name="name" type="text" class="mt-1 block w-full" />
                    @if ($errors->has('name'))
                ...
                <div class="w-1/2">
                    ...
                    <x-text-input value="{{ old('sort', $attribute->sort) }}" id="sort" name="sort" type="text" class="mt-1 block w-full" />
                    @if ($errors->has('sort'))
            ...
            <div class="flex flex-wrap mb-4 w-full">
                ...
                <div class="w-1/2 pr-4">
                    ...
                    <textarea id="variants" type="text" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" name="variants">{{ old('variants', implode("\n", $attribute->variants)) }}</textarea>
            ...
            <div class="mb-4">
                ...
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="required" {{ old('required', $attribute->required) ? 'checked' : '' }}> Обязательно
                    </label>
                </div>
